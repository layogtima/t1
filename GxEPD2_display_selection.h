...
#if defined(ESP32)
GxEPD2_BW<GxEPD2_154_GDEY0154D67, GxEPD2_154_GDEY0154D67::HEIGHT> display(GxEPD2_154_GDEY0154D67(/*CS=5*/ 5, /*DC=*/ 20, /*RST=*/ -1, /*BUSY=*/ 9)); // GDEY0154D67 200x200, SSD1681, (FPC-B001 20.05.21)
